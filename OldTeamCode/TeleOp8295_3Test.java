...
@TeleOp(name = "TeleOp8295_3Test", group = "Zhou")
public class TeleOp8295_3Test extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if(gamepad1.right_stick_x> 0){
                robot.goRight(gamepad1.right_stick_x*0.7);
            }
            if(gamepad1.right_stick_x< 0){
                robot.goLeft(-gamepad1.right_stick_x*0.7);
            }
